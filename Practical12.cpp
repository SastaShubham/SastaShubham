...
int main()
{
 ...
 do
 {
  ...
  case 2:
   ...
   break;
  case 3:
   cout<<"\nEnter the ID number you want to find";
   cin>>rec;
  ...
  case 4:
   ...
   break;
      case 5:
            cout<<"\n\tEnter the ID number you want to modify";
            cin>>on;
            f.open("emprecord.txt",ios::in|ios::out);
            f.read((char*) &t1,(sizeof(t1)));
            while(f)
   ...
   break;
    case 7:
      int ID;
      cout<<"Please Enter the ID No. of Student Whose Info You Want to Delete: ";
     cin>>ID;
     f.open("emprecord.txt",ios::in);
    ...
    cout << "The record with the ID no. " << ID << " has been deleted " << endl;
     f.close();
     g.close();
